...
/* ── Students ── */
export const seedStudents: AppUser[] = [
  {
    id: "stu-1",
    name: "Aarav Sharma",
...
/* ── Rooms ── */
export const seedRooms: RoomDetails[] = [
...
export const seedComplaints: Complaint[] = [
  {
    id: "cmp-1",
    title: "No water supply in washroom",
    description: "Water has not been available since yesterday morning. Multiple students affected.",
    category: "Water",
    status: "open",
    priority: ComplaintPriorities.CRITICAL,
  ...
  },
  {
    ...
    description: "Food was cold and undercooked during dinner. Found foreign object in dal.",
    category: "Mess",
    status: "in-progress",
    priority: ComplaintPriorities.HIGH,
    createdAt: "2026-04-04T19:15:00Z",
    createdBy: "stu-2",
  ...
  },
  {
    ...
    description: "The window glass is cracked and poses a safety hazard during rain.",
  ...
  },
  {
    ...
    description: "Internet connectivity has been down for the past two days on the entire second floor.",
    category: "WiFi",
    status: "in-progress",
  ...
  },
  {
    ...
    description: "Frequent power cuts and voltage fluctuations in Block B. Electronics getting damaged.",
  ...
  },
  {
    ...
    description: "Drain is blocked and water is overflowing into the room corridor.",
    category: "Maintenance",
    status: "resolved",
    priority: ComplaintPriorities.HIGH,
  ...
  },
  {
    ...
    description: "The tube light in my room has been flickering and finally stopped working.",
    category: "Electricity",
    status: "resolved",
    priority: ComplaintPriorities.LOW,
    createdAt: "2026-03-30T20:10:00Z",
    createdBy: "stu-7",
  ...
  },
  {
    ...
    description: "Cockroach and ant infestation in room. Need urgent pest control treatment.",
    category: "Maintenance",
    status: "open",
    priority: ComplaintPriorities.MEDIUM,
...
export const seedNotices: Notice[] = [
  { id: "notice-1", title: "Water Tank Cleaning", content: "Water supply will be unavailable from 10 AM to 1 PM on Sunday for routine tank cleaning and maintenance.", postedAt: "2026-04-06T09:00:00Z", postedBy: "admin-1", category: "Maintenance", isActive: true },
  { id: "notice-2", title: "Hostel Curfew Reminder", content: "All students must return to hostel by 9:30 PM. Gate pass is mandatory for late entry. Violations will result in penalty.", postedAt: "2026-04-05T14:00:00Z", postedBy: "admin-1", category: "General", isActive: true },
  { id: "notice-3", title: "Semester Fee Due Date", content: "Last date for hostel fee payment is April 15, 2026. Late payment will attract a fine of ₹500 per day. Pay via online portal.", postedAt: "2026-04-03T10:00:00Z", postedBy: "admin-1", category: "Fee", isActive: true },
  { id: "notice-4", title: "Annual Sports Meet", content: "Hostel sports tournament starts from April 20th. Register for cricket, badminton, volleyball, and chess at the sports office.", postedAt: "2026-04-01T08:30:00Z", postedBy: "admin-1", category: "Events", isActive: true },
  { id: "notice-5", title: "Mess Menu Update", content: "New mess menu has been updated for April. Special weekend breakfast items added based on student feedback.", postedAt: "2026-03-30T12:00:00Z", postedBy: "admin-1", category: "Mess", isActive: false },
];

/* ── Mess Menu ── */
export const seedMessMenu: MessMenu[] = [
...
/* ── Mess Feedback ── */
export const seedMessFeedback: MessFeedback[] = [
